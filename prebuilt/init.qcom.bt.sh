...
/system/bin/brcm_patchram_plus --patchram /system/etc/firmware/BCM4330B1_002.001.003.0243.0305.hcd /dev/ttyHS0
/system/bin/brcm_patchram_plus --baudrate 4000000 /dev/ttyHS0
